...
class MyWindow(QWidget):
    def __init__(self):
        ...
        self.label.setStyleSheet("""font-size: 20px; 
                                ...
                                text-align: center; 
                                margin-top: 20px;""")
        self.label.setStyleSheet("font-size: 20px; font-weight: bold; color: green; margin-top: 20px;")
        ...
        for name in self.plant_data.keys():
            ...
            button.setStyleSheet("font-size: 14px; background-color: white; border-radius: 44px; border: 2px solid green;")
